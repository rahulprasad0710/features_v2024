                        ...
                        <div className='overflow-y-auto h-screen p-3 mb-9 pb-20'>
                            ...
                            <div className='flex items-center mb-4 cursor-pointer hover:bg-gray-100 p-2 rounded-md'>
                                ...
                                <div className='flex-1'>
                                    ...
                                    <p className='text-gray-600'>
                                        That pizza place was amazing! We should
                                        go again sometime. 🍕
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className='flex items-center mb-4 cursor-pointer hover:bg-gray-100 p-2 rounded-md'>
                                ...
                                <div className='flex-1'>
                                    ...
                                    <p className='text-gray-600'>
                                        I just finished reading a great book! It
                                        was so captivating.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className='flex items-center mb-4 cursor-pointer hover:bg-gray-100 p-2 rounded-md'>
                                ...
                                <div className='flex-1'>
                                    ...
                                    <p className='text-gray-600'>
                                        I heard there's a new exhibit at the art
                                        museum. Interested?
                                    </p>
                                </div>
                            </div>
                            <div className='flex items-center mb-4 cursor-pointer hover:bg-gray-100 p-2 rounded-md'>
                                ...
                                <div className='flex-1'>
                                    ...
                                    <p className='text-gray-600'>
                                        I tried that new cafe downtown. The
                            ...
                            <div className='flex items-center mb-4 cursor-pointer hover:bg-gray-100 p-2 rounded-md'>
                                ...
                                <div className='flex-1'>
                                    ...
                                    <p className='text-gray-600'>
                                        I'm planning a hiking trip next month.
                                        Want to join?
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className='flex items-center mb-4 cursor-pointer hover:bg-gray-100 p-2 rounded-md'>
                                ...
                                <div className='flex-1'>
                                    ...
                                    <p className='text-gray-600'>
                                        Remember that hilarious joke you told
                        ...
                        <div className='h-screen overflow-y-auto p-4 pb-36'>
                            ...
                            <div className='flex justify-end mb-4 cursor-pointer'>
                                <div className='flex max-w-96 bg-indigo-500 text-white rounded-lg p-3 gap-3'>
                                    <p>
                                        Hi Alice! I'm good, just finished a
                            ...
                            <div className='flex justify-end mb-4 cursor-pointer'>
                                <div className='flex max-w-96 bg-indigo-500 text-white rounded-lg p-3 gap-3'>
                                    <p>
                                        It's about an astronaut stranded on
                                        Mars, trying to survive. Gripping stuff!
                                    </p>
                                </div>
                                <div className='w-9 h-9 rounded-full flex items-center justify-center ml-2'>
                                    <img
                            ...
                            <div className='flex mb-4 cursor-pointer'>
                                ...
                                <div className='flex max-w-96 bg-white rounded-lg p-3 gap-3'>
                                    <p className='text-gray-700'>
                                        I'm intrigued! Maybe I'll borrow it from
                            ...
                            <div className='flex justify-end mb-4 cursor-pointer'>
                                <div className='flex max-w-96 bg-indigo-500 text-white rounded-lg p-3 gap-3'>
                                    <p>
                                        Of course! I'll drop it off at your
                                        place tomorrow.
                                    </p>
                                </div>
                                <div className='w-9 h-9 rounded-full flex items-center justify-center ml-2'>
                            ...
                            <div className='flex justify-end mb-4 cursor-pointer'>
                                <div className='flex max-w-96 bg-indigo-500 text-white rounded-lg p-3 gap-3'>
                                    <p>
                                        Absolutely! Can't wait for our pizza
                                        date. 🍕
                                    </p>
                                </div>
                                <div className='w-9 h-9 rounded-full flex items-center justify-center ml-2'>
